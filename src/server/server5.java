...
//
//public class server5 implements mapIF {
//    int curServer;
...
//    private Map<UUID, Request5> temporaryStorage = new HashMap<>();
...
//            Request5 reqestToCommitGlobally = this.temporaryStorage.get(transactID);
//
...
//
//        Request5 requestToCommit = this.temporaryStorage.get(messageId);
//
...
//
//        hlp.loadServers(9999);
//        try{
////            Coordinator.servs.add(new server5());
//
//            server5 sr5 = new server5();
//            hlp.setServer(sr5);
////            hlp.setServer(sr5);
////            Coordinator.setServer(sr5);
//            mapIF stub = (mapIF) UnicastRemoteObject.exportObject(sr5, 0);
//            Registry registry = LocateRegistry.createRegistry(9999);
//            registry.bind("server.mapIF", stub);
////            registerOtherServers(serverInfo.servers, serverInfo.servers[i]);
//            hlp.registerOtherServers(9999);
//            System.out.println("Server-5" +" is running at port"+9999);
//        } catch (Exception e) {
