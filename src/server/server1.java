...
//
//public class server1 implements mapIF {
//    int curServer;
...
//    private Map<UUID, Request1> temporaryStorage = new HashMap<>();
...
//            Request1 reqestToCommitGlobally = this.temporaryStorage.get(transactID);
//
...
//
//        Request1 requestToCommit = this.temporaryStorage.get(messageId);
//
...
//        Coordinator.loadServers(9194);
//
//        try{
////            Coordinator.servs.add(new server1());
//            Coordinator.setServer(new server1());
//
//            server5 svr = (server5) Coordinator.servs.get(4);
//            mapIF stub = (mapIF) UnicastRemoteObject.exportObject(svr, 0);
//            Registry registry = LocateRegistry.createRegistry(9194);
//            registry.bind("server.mapIF", stub);
////            registerOtherServers(serverInfo.servers, serverInfo.servers[i]);
//            Coordinator.registerOtherServers(9194);
//
//            System.out.println("Server-1" +" is running at port"+9194);
//        } catch (Exception e) {
