...
//
//public class server4 implements mapIF {
//    int curServer;
...
//    private Map<UUID, Request4> temporaryStorage = new HashMap<>();
...
//    public static serverHelper hlp = new serverHelper();
//    /**
...
//            Request4 reqestToCommitGlobally = this.temporaryStorage.get(transactID);
//
...
//
//        Request4 requestToCommit = this.temporaryStorage.get(messageId);
//
...
//        hlp.loadServers(9191);
//        try{
////            Coordinator.servs.add(new server4());
//            server4 sr4 = new server4();
//            hlp.setServer(sr4);
////            Coordinator.setServer(sr4);
//            mapIF stub = (mapIF) UnicastRemoteObject.exportObject(sr4, 0);
//            Registry registry = LocateRegistry.createRegistry(9191);
//            registry.bind("server.mapIF", stub);
////            registerOtherServers(serverInfo.servers, serverInfo.servers[i]);
//            hlp.registerOtherServers(9191);
//
//            System.out.println("Server-4" +" is running at port"+9191);
//        } catch (Exception e) {
//            System.err.println("Server exception: " + e.toString());
//        }
//
//        System.out.println(hlp.getSize());
