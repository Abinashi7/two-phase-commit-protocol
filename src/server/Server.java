...
public class Server implements mapIF {
    int curServer;
    ...
    private Map<UUID, Request> temporaryStorage = new HashMap<>();
    ...
    public String beginTransaction(UUID transactID, String service, String key, String value) {
        if(service.equalsIgnoreCase("GET")){
            ...
            Request reqestToCommitGlobally = this.temporaryStorage.get(transactID);
...
//
   ...
   void printLog(String message){
    ...
    public void commitCommand(UUID messageId, int currentserver) {
       ...
       Request requestToCommit = this.temporaryStorage.get(messageId);
