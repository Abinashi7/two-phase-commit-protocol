...
public class Server2 implements mapIF {
    int curServer;
    ...
    private Map<UUID, Request2> temporaryStorage = new HashMap<>();
    ...
    public String beginTransaction(UUID transactID, String service, String key, String value) {
        if(service.equalsIgnoreCase("GET")){
            ...
            Request2 reqestToCommitGlobally = this.temporaryStorage.get(transactID);
...
//
   ...
   void printLog(String message){
    ...
    public void commitCommand(UUID messageId, int currentserver) {
       ...
       Request2 requestToCommit = this.temporaryStorage.get(messageId);
...
//        Coordinator.register(Integer.parseInt(args[0]));
    }
}
